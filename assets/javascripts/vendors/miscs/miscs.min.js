/*!
    ...
    Plugin URL: https://github.com/gdsmith/jquery.easing
...
/*!
    Modernizr
    Version: 2.6.2 (Custom Build)
    Plugin URL: http://modernizr.com/download/#-touch-shiv-cssclasses-teststyles-prefixes-load
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*
    ...
    Plugin URL: https://github.com/bas2k/jquery.appear/
    Plugin URL: http://code.google.com/p/jquery-appear/
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*!
    Navigation Menu
    Version: 2.5
    Plugin URL: https://codecanyon.net/item/web-slide-bootstrap-4-mega-menu-responsive/21299306
*/
$(void(document.addEventListener("touchstart",function(){},!1),$(function(){$("body").wrapInner('<div class="wsmenucontainer" />'),$('<div class="overlapblackbg"></div>').prependTo(".wsmenu"),$("#wsnavtoggle").click(function(){$("body").toggleClass("wsactive")}),$(".overlapblackbg").click(function(){$("body").removeClass("wsactive")}),$(".wsmenu > .wsmenu-list > li").has(".sub-menu").prepend('<span class="wsmenu-click"><i class="wsmenu-arrow"></i></span>'),$(".wsmenu > .wsmenu-list > li").has(".wsmegamenu").prepend('<span class="wsmenu-click"><i class="wsmenu-arrow"></i></span>'),$(".wsmenu-click").click(function(){$(this).toggleClass("ws-activearrow").parent().siblings().children().removeClass("ws-activearrow"),$(".wsmenu > .wsmenu-list > li > .sub-menu, .wsmegamenu").not($(this).siblings(".wsmenu > .wsmenu-list > li > .sub-menu, .wsmegamenu")).slideUp("slow"),$(this).siblings(".sub-menu").slideToggle("slow"),$(this).siblings(".wsmegamenu").slideToggle("slow")}),$(".wsmenu > .wsmenu-list > li > ul > li").has(".sub-menu").prepend('<span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span>'),$(".wsmenu > .wsmenu-list > li > ul > li > ul > li").has(".sub-menu").prepend('<span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span>'),$(".wsmenu-click02").click(function(){$(this).children(".wsmenu-arrow").toggleClass("wsmenu-rotate"),$(this).siblings("li > .sub-menu").slideToggle("slow")}),$(window).on("resize",function(){992>$(window).outerWidth()?($(".wsmenu").css("height",$(this).height()+"px"),$(".wsmenucontainer").css("min-width",$(this).width()+"px")):($(".wsmenu").removeAttr("style"),$(".wsmenucontainer").removeAttr("style"),$("body").removeClass("wsactive"),$(".wsmenu > .wsmenu-list > li > .wsmegamenu, .wsmenu > .wsmenu-list > li > ul.sub-menu, .wsmenu > .wsmenu-list > li > ul.sub-menu > li > ul.sub-menu, .wsmenu > .wsmenu-list > li > ul.sub-menu > li > ul.sub-menu > li > ul.sub-menu").removeAttr("style"),$(".wsmenu-click").removeClass("ws-activearrow"),$(".wsmenu-click02 > i").removeClass("wsmenu-rotate"))}),$(window).trigger("resize")})));

/*!
    jQuery Marquee
    Version: 1.4.0
    Plugin URL: http://aamirafridi.com/jquery/jquery-marquee-plugin
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*!
    Owl Carousel 
    Version: 2.3.4
    Plugin URL: https://owlcarousel2.github.io/OwlCarousel2/
    License: Licensed under: SEE LICENSE IN https://github.com/OwlCarousel2/OwlCarousel2/blob/master/LICENSE
!*/
...
/*!
    ...
    Version: 1.19.5
    Plugin URL: https://jqueryvalidation.org/
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*!
    jQuery ajaxChimp Plugin
    Plugin URL: https://github.com/scdoshi/jquery-ajaxchimp
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*!
    jQuery Pooper Plugin
    Plugin URL: https://popper.js.org/docs/v2/
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*!
    jQuery Animations Plugin
    Version: 1.3.0
    Plugin URL: https://wowjs.uk/
    License: Licensed under the MIT license (http://www.opensource.org/licenses/mit-license.php)
!*/
...
/*!
    Slideshow
!*/
var slideshowDuration=4e3,slideshow=$(".slideshow");function slideshowSwitch(i,e,s){var t,a,o,d,n,l,h,w,c,r,f,u,m,g,x,v;i.data("wait")||(t=i.find(".slide"),i.find(".pagination"),a=t.filter(".is-active"),o=a.find(".image-container"),d=t.eq(e),n=d.find(".image-container"),l=d.find(".slide-content"),h=d.find(".caption > *"),d.is(a)||(d.addClass("is-new"),w=i.data("timeout"),clearTimeout(w),i.data("wait",!0),"fade"==i.attr("data-transition")?(d.css({display:"block",zIndex:2}),n.css({opacity:0}),TweenMax.to(n,1,{alpha:1,onComplete:function(){d.addClass("is-active").removeClass("is-new"),a.removeClass("is-active"),d.css({display:"",zIndex:""}),n.css({opacity:""}),i.find(".pagination").trigger("check"),i.data("wait",!1),s&&(w=setTimeout(function(){slideshowNext(i,!1,!0)},slideshowDuration),i.data("timeout",w))}})):(e=d.index()>a.index()?(c=0,r="auto",f=-i.width()/8,x=g=u="auto",v=m=0,-i.width()/4):(c="",r=0,f="auto",u=-i.width()/8,m="",x=g=0,v="auto",i.width()/4),d.css({display:"block",width:0,right:c,left:r,zIndex:2}),n.css({width:i.width(),right:f,left:u}),l.css({width:i.width(),left:x,right:v}),o.css({left:0}),TweenMax.set(h,{y:20,force3D:!0}),TweenMax.to(o,1,{left:e,ease:Power3.easeInOut}),TweenMax.to(d,1,{width:i.width(),ease:Power3.easeInOut}),TweenMax.to(n,1,{right:m,left:g,ease:Power3.easeInOut}),TweenMax.staggerFromTo(h,.8,{alpha:0,y:60},{alpha:1,y:0,ease:Power3.easeOut,force3D:!0,delay:.6},.1,function(){d.addClass("is-active").removeClass("is-new"),a.removeClass("is-active"),d.css({display:"",width:"",left:"",zIndex:""}),n.css({width:"",right:"",left:""}),l.css({width:"",left:""}),h.css({opacity:"",transform:""}),o.css({left:""}),i.find(".pagination").trigger("check"),i.data("wait",!1),s&&(w=setTimeout(function(){slideshowNext(i,!1,!0)},slideshowDuration),i.data("timeout",w))}))))}function slideshowNext(i,e,s){var t=i.find(".slide"),a=t.filter(".is-active"),o=null;e?0===(o=a.prev(".slide")).length&&(o=t.last()):0==(o=a.next(".slide")).length&&(o=t.filter(".slide").first()),slideshowSwitch(i,o.index(),s)}function homeSlideshowParallax(){var i,e,s=$(window).scrollTop();s>windowHeight||(i=slideshow.find(".slideshow-inner"),e=windowHeight-s/2,s=.8*s,i.css({transform:"translateY("+s+"px)",height:e}))}$(document).ready(function(){$(".slide").addClass("is-loaded"),$(".slideshow .arrows .arrow").on("click",function(){slideshowNext($(this).closest(".slideshow"),$(this).hasClass("prev"))}),$(".slideshow .pagination .item").on("click",function(){slideshowSwitch($(this).closest(".slideshow"),$(this).index())}),$(".slideshow .pagination").on("check",function(){var i=$(this).closest(".slideshow"),e=$(this).find(".item"),i=i.find(".slides .is-active").index();e.removeClass("is-active"),e.eq(i).addClass("is-active")});var i=setTimeout(function(){slideshowNext(slideshow,!1,!0)},slideshowDuration);slideshow.data("timeout",i)}),1<$(".main-content .slideshow").length&&$(window).on("scroll",homeSlideshowParallax);
